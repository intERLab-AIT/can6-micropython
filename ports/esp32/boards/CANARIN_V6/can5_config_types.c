...
static can5_cfg_meta_t default_elem[] = {
    ...
    CFG_ITEM(CFG_WIFI_STA_ENABLE,       NETIF_TAG,          TAG_FS,             BOOLEAN_LEN,    "false"         ),
    CFG_ITEM(CFG_WIFI_STA_SSID,         NETIF_TAG,          TAG_FS,             URI_LEN,        ""              ),
    CFG_ITEM(CFG_WIFI_STA_PASS,         NETIF_TAG,          TAG_FS,             DEFAULT_LEN,    ""              ),
